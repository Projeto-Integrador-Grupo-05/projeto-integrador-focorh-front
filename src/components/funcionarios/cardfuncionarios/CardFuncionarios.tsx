        ...
        <div className='border flex flex-col overflow-hidden justify-between 
            ...
            <section className="flex p-4 items-center bg-emerald-50">
                    <img 
                        ...
                        className="w-32 h-32 rounded-full mr-12"
                    />            
                <div className='flex flex-col'>
                    <h2 className="text-xl font-medium">Informações</h2>
                    <ul className="mt-2">
                        <li><strong>Admissão:</strong>{funcionario.admissao}</li>
                        <li><strong>Email:</strong>{funcionario.email}</li>
                        <li><strong>Departamento:</strong>{funcionario.departamento}</li>
                        <li><strong>Cargo:</strong>{funcionario.cargo}</li>
                        <li><strong>Funcional:</strong>{funcionario.funcional}</li>
