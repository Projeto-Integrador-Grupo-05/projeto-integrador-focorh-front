...
function FormFuncionario() {
    ...
    return (
        <div className="container flex flex-col mx-auto items-center bg-teal-960">
            ...
            <form className="flex flex-col w-1/2 gap-4" onSubmit={gerarNovafuncionario}>
                <div className="flex flex-col w-full">
                    <label htmlFor="nome" className="text-white">Nome do funcionario*</label>
                ...
                <div className="flex flex-col w-full">
                    <label htmlFor="cargo" className="text-white">Cargo do funcionario*</label>
                    <div className="p-[2px] bg-gradient-to-r from-yellow-500 to-lime-100 rounded">
                        <input
                            type="text"
                            id="cargo"
                ...
                <div className="flex flex-col w-full">
                    <label htmlFor="Departamento" className="text-white">Departamento do funcionario*</label>
                    <div className="p-[2px] bg-gradient-to-r from-yellow-500 to-lime-100 rounded">
                        <select
                            name="Departamento"
                            id="Departamento"
